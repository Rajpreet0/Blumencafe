...
export default function Speisekarte({speisekarte}:Props) {
  ...
  return (
    <div>
      <Header/>
        <div className='min-h-screen font-merri pt-44' style={{backgroundColor: '#FFDF9BFF'}}>
            
           <div className='flex flex-col w-full items-center'>
                <h1 className='font-satisfy  text-7xl' style={{color: '#0F3D3E'}}>Speisekarte</h1>
                ...
                <p className='mt-4  text-center md:max-w-3xl md:p-4'>
